...
**一款专注「娱乐 + 群管」的 QQ 机器人插件**

[![项目状态](https://img.shields.io/badge/状态-活跃-brightgreen?style=flat-square)](https://github.com/HANG-XM/XIAOMENG)
...
| 模块 | 说明 |
| :--- | :--- |
| 🎮 **娱乐互动** | 签到、答题、点歌、表情包、小游戏……一键开启活跃气氛 |
| 🛡️ **群务管理** | 入群审核、关键词检测、警告与禁言、自动踢人，规则清晰 |
| ⚔️ **PK 对战** | 玩家之间可进行实时战斗 |
| 🌾 **农场系统** | 种植、偷菜、浇水、收获，丰富的模拟经营玩法 |
| 📈 **股票系统** | 实时股票交易，体验资本市场的魅力 |
| 🎣 **钓鱼系统** | 多种鱼类，图鉴收集，休闲娱乐 |
...
👉 **[点击下载最新版](https://github.com/HANG-XM/XIAOMENG/releases/latest)**
...
### 1. 下载插件
从 [Releases 页面](https://github.com/HANG-XM/XIAOMENG/releases) 下载最新版 `XIAOMENG.zip`，解压得到 `小梦.dll`。
